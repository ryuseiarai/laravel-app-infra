    ...
    [
      {
        ...
        logConfiguration = {
          logDriver = "awslogs"
          options = {
            awslogs-group         = data.terraform_remote_state.log_app_foobar.outputs.log_group_nginx
      ...
      },
      {
        ...
        logConfiguration = {
          logDriver = "awslogs"
          options = {
            awslogs-group         = data.terraform_remote_state.log_app_foobar.outputs.log_group_php
            awslogs-region        = data.aws_region.current.id
            awslogs-stream-prefix = "ecs"
          }
        }
